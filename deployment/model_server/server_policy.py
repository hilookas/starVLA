...
def main(args) -> None:
    ...
    logging.info("Creating server (host: %s, ip: %s, bind: %s)", hostname, local_ip, args.host)
...
def build_argparser():
    ...
    parser.add_argument("--host", type=str, default=os.environ.get("STARVLA_SERVER_HOST", "0.0.0.0"),
                        help="Bind address. Use 127.0.0.1 in sandboxes that forbid binding 0.0.0.0.")
